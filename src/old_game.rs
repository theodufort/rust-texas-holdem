...
use crate::{deck::Deck, player::Player, Card};
                ...
                match input.trim() {
                    ...
                    "3" => {
                        let wager_amount: u32 = loop {
                            print!("Enter wager amount (1% to 100% of your balance): ");
